...
import 'add_restricted_area_screen.dart';

class ManageRestrictedAreasScreen extends StatelessWidget {
  const ManageRestrictedAreasScreen({super.key});
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AddRestrictedAreaScreen()),
          );
        },
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Add areas where exhaust should auto-close',
